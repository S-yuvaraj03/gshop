...
class _PaymentPageState extends State<PaymentPage> {
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              buildPaymentMethodOption(
                  'PayPal', 'assets/images/paypal.png', '************XXXX'),
              buildPaymentMethodOption('MasterCard',
                  'assets/images/mastercard.png', '************XXXX'),
              buildPaymentMethodOption(
                  'Google Pay', 'assets/images/gpay.png', 'UPI id:XXX XXX@axl'),
              SizedBox(height: 32),
              ElevatedButton(
                ...
                onPressed: selectedPaymentMethod == null
                    ...
                    : () async {
                        ...
                        bool paymentSuccessResult =
                            DateTime.now().second % 2 == 0;

                        Navigator.of(context)
                            .pop(); // Dismiss the loading alert
                            ...
                            MaterialPageRoute(
                              builder: (context) => ConfirmationOfOrderPage(
                                ...
                                deliveryAddress: widget
                                    .deliveryAddress, // Pass delivery address
                              ),
                            ),
                          );
                        } else {
  ...
  Widget buildPaymentMethodOption(
      String method, String logo, String cardNumber) {
