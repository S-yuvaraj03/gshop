class Product {
  ...
  factory Product.fromMap(Map<String, dynamic> data) {
    return Product(
      ...
      product_price: (data['product_price'] ?? 0.0).toDouble(),
      product_offerprice: (data['product_offerprice'] ?? 0.0).toDouble(),
      product_cateogory: data['product_cateogory'] ?? '',
      product_availability: data['product_availability'] ?? false,
      product_rating: (data['product_rating'] ?? 0.0).toDouble(),
